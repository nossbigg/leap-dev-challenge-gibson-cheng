...
export const getPrompts = async (): Promise<Prompt[]> => {
  const response = await fetch(`${getBackendApiUrl()}/prompts`, {
    method: "GET",
  });
...
export const getPrompt = async (
  ...
  const response = await fetch(`${getBackendApiUrl()}/prompts/${promptId}`, {
    method: "GET",
  });
...
export const updatePrompt = async (
  ...
  await fetch(`${getBackendApiUrl()}/prompts/${promptId}`, {
    method: "PATCH",
    headers: {
